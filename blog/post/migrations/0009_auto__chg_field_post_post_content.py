...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'post_post', 'post_content', self.gf('ckeditor.fields.RichTextField')(max_length=6000))
    ...
    models = {
        u'post.post': {
            ...
            'post_content': ('ckeditor.fields.RichTextField', [], {'max_length': '6000'}),
