var blogApp = angular.module('blogApp', ['ngRoute', 'PostServices', 'TagServices', 'CommentServices',
    'UserServices', 'CurrentUserServices', 'ngCookies', 'http-auth-interceptor'], function ($interpolateProvider) {
    ...
    return {
        ...
        link: function ($scope, elem, attrs) {
            ...
            elem.bind('submit', function () {
                ...
                $http.post('/api-token-auth/', user_data, {"Authorization": ""})
...
blogApp.directive('authApplication', function ($cookieStore, $http, CurrentUser) {
    return {
        restrict: 'A',
        link: function ($scope, elem, attrs) {
